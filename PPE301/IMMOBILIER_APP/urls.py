...
urlpatterns = [
    ...
    path('supprimer_vente/<int:ventesupp_id>/', views.supprimer_vente, name='supprimer_vente'),
    path('modifier_location/<int:location_id>/', views.modifier_location, name='modifier_location'),
    path('supprimer_location/<int:locationsupp_id>/', views.supprimer_location, name='supprimer_location'),
